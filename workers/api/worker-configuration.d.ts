/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 901df858baf37e48f24eb95d08e0dfce)
// Runtime types generated with workerd@1.20260611.1 2026-05-26 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	ENABLE_OTP_DEV_RESPONSE?: "true" | "false";
	PUBLIC_R2_URL?: "storage.talash.bd" | "https://storage-test.talash.bd" | "https://storage.mahannankhan.info";
	ALLOWED_ORIGINS?: "http://localhost:3000,http://localhost:3001" | "https://test.talash.bd, https://test-studio.talash.bd, http://localhost:3000, http://localhost:3001" | "https://talash.mahannankhan.info, https://business.mahannankhan.info, https://talash-marketing-site.rajinhasan-app.workers.dev, https://talash-business-dashboard.rajinhasan-app.workers.dev, https://talash-marketing-site-staging.rajinhasan-app.workers.dev, https://talash-business-dashboard-staging.rajinhasan-app.workers.dev" | "https://talash.mahannankhan.info, https://talash-marketing-site.rajinhasan-app.workers.dev, https://talash-business-dashboard.rajinhasan-app.workers.dev, https://talash-marketing-site-production.rajinhasan-app.workers.dev, https://talash-business-dashboard-production.rajinhasan-app.workers.dev";
	...
	GOOGLE_CLIENT_ID?: "163196138441-dvuciv0t2ddnkr61fck5r9i9v2jq0a64.apps.googleusercontent.com" | "<GOOGLE_CLIENT_ID_TEST>";
	AUTH_SERVICE?: Fetcher /* talash-auth-service */;
	LPG_SERVICE?: Fetcher /* talash-lpg-service */;
	BOOKING_SERVICE?: Fetcher /* talash-booking-service */;
	TALASH_EMAIL_TEST?: SendEmail;
	TALASH_AI?: Ai;
	TALASH_EMAIL?: SendEmail;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		GOOGLE_CLIENT_ID: "163196138441-dvuciv0t2ddnkr61fck5r9i9v2jq0a64.apps.googleusercontent.com";
		ALLOWED_ORIGINS: "https://talash.mahannankhan.info, https://business.mahannankhan.info, https://talash-marketing-site.rajinhasan-app.workers.dev, https://talash-business-dashboard.rajinhasan-app.workers.dev, https://talash-marketing-site-staging.rajinhasan-app.workers.dev, https://talash-business-dashboard-staging.rajinhasan-app.workers.dev";
		AUTH_SERVICE: Fetcher /* talash-auth-service */;
		LPG_SERVICE: Fetcher /* talash-lpg-service */;
		BOOKING_SERVICE: Fetcher /* talash-booking-service */;
	}
	interface ProductionEnv {
		...
		PUBLIC_R2_URL: "https://storage.mahannankhan.info";
		GOOGLE_CLIENT_ID: "163196138441-dvuciv0t2ddnkr61fck5r9i9v2jq0a64.apps.googleusercontent.com";
		ALLOWED_ORIGINS: "https://talash.mahannankhan.info, https://talash-marketing-site.rajinhasan-app.workers.dev, https://talash-business-dashboard.rajinhasan-app.workers.dev, https://talash-marketing-site-production.rajinhasan-app.workers.dev, https://talash-business-dashboard-production.rajinhasan-app.workers.dev";
		AUTH_SERVICE: Fetcher /* talash-auth-service */;
		LPG_SERVICE: Fetcher /* talash-lpg-service */;
		BOOKING_SERVICE: Fetcher /* talash-booking-service */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENABLE_OTP_DEV_RESPONSE" | "PUBLIC_R2_URL" | "ALLOWED_ORIGINS" | "ALLOWED_RESET_URIS" | "EMAIL_FROM" | "JWT_SECRET" | "GOOGLE_CLIENT_ID">> {}
}
